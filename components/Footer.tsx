export default function Footer() {
  return (
    <footer className="glass border-t border-gray-200 dark:border-gray-800 py-12 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Your voice-first iOS agent for hands-free automation
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600 dark:text-gray-400">
              ...
              <li><a href="#workflows" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Workflows</a></li>
              <li><a href="#how-it-works" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">How It Works</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600 dark:text-gray-400">
              <li><a href="#" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">API Reference</a></li>
              <li><a href="#" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Shortcut Templates</a></li>
